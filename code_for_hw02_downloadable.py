...
def tidy_plot(xmin, xmax, ymin, ymax, center=False, title=None, xlabel=None, ylabel=None):
    """
    Set up axes for plotting xmin, xmax, ymin, ymax = (float) plot extents
...
def perceptron(data, labels, params={}, hook=None):
    """
    Implements the perceptron algorithm on training data with classifier labels.
    :param data: is a numpy array of dimension d by n representing the samples
    :param labels: is numpy array of dimension 1 by n representing the labels of the samples
    :param params: Specifies the number of iterations T for the perceptron algorithm
...
def averaged_perceptron(data, labels, params={}, hook=None):
    """
    Implements the averaged perceptron algorithm on training data with classifier labels.
    :param data: is a numpy array of dimension d by n representing the samples
    :param labels: is numpy array of dimension 1 by n representing the labels of the samples
    :param params: Specifies the number of iterations T for the perceptron algorithm
    :param hook: deprecated.
    ...
    for tao in range(T):
        for i in range(num_samples):
            ...
            ths += theta
            th0s += theta_0
    return ths / (num_samples * T), th0s / (num_samples * T)
...
def eval_classifier(learner, data_train, labels_train, data_test, labels_test):
    ...
    :param learner: a function, such as perceptron or averaged_perceptron
    :param data_train: training data
    :param labels_train: training labels
    :param data_test: test data
    :param labels_test: test labels
    :return: the percentage correct on a new testing set as a float between 0. and 1
    """
...
def eval_learning_alg(learner, data_gen, n_train, n_test, it):
    """
    Evaluates a learning algorithm using a data source
    :param learner: a function, such as perceptron or averaged_perceptron
    :param data_gen: a data generator, call it with a desired data set size; returns a tuple (data, labels)
    :param n_train: the size of the learning sets
    :param n_test: the size of the test sets
    :param it: the number of iterations to average over
    :return: the average classification accuracy as a float between 0. and 1
    """
    score_sum = 0
    for i in range(it):
...
def eval_learning_alg1(learner, data_gen, n_train, n_test, it):
    """
    Evaluates a learning algorithm using a data source. Problem 10 part 2.
    :param learner: a function, such as perceptron or averaged_perceptron
    :param data_gen: a data generator, call it with a desired data set size; returns a tuple (data, labels)
    :param n_train: the size of the learning sets
    :param n_test: the size of the test sets
    ...
    for i in range(it):
        data_train, labels_train = data_gen(n_train)
        score_sum += eval_classifier(learner, data_train, labels_train, data_train, labels_train)
    return score_sum / it
...
def xval_learning_alg(learner, data, labels, k):
    """
    Evaluates a learning algorithm using cross validation on a fixed data source of size n. Assumes data is
    shuffled.
    :param learner: a function, such as perceptron or averaged_perceptron
    :param data: training and testing data
    :param labels: trainiong and testing labels
    :param k: the number of iterations to average over and split the data source
    :return: the average classification accuracy as a float between 0. and 1
    """
...
# For problem 10, here is an example of how to use gen_flipped_lin_separable,
# in this case with a flip probability of 50%
# print(eval_learning_alg(perceptron, gen_flipped_lin_separable(pflip=.1), 20, 20, 5))

# Problem 10 test cases:
# scr = 0
# for i in range(100):
#     scr += eval_learning_alg(perceptron, gen_flipped_lin_separable(pflip=.25), 20, 20, 5)
# print(scr/100)

# scr = 0
# for i in range(100):
#     scr += eval_learning_alg(averaged_perceptron, gen_flipped_lin_separable(pflip=.25), 20, 20, 5)
# print(scr/100)

# Problem 10 part 2 test cases:
# scr = 0
# for i in range(100):
#     scr += eval_learning_alg1(perceptron, gen_flipped_lin_separable(pflip=.25), 20, 20, 5)
# print(scr/100)
#
# scr = 0
# for i in range(100):
#     scr += eval_learning_alg1(averaged_perceptron, gen_flipped_lin_separable(pflip=.25), 20, 20, 5)
# print(scr/100)
